...
- A candidate with no churn evidence and no deletion-test verdict is `unverified`; label it so — never promote it into the ranked list as if it were vetted.

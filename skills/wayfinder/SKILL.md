...
- **Research** (AFK): a fact a decision waits on. Resolved by a [`research`](../research/SKILL.md) subagent that leaves a human-readable gist in the ticket comment as the top disclosure layer and links the committed findings file beneath it; the link alone is too low-res to act on.
